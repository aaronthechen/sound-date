...
let selectedMonth, selectedDay, previousDay
...
submitButton.addEventListener('click', () => {
    if (selectedMonth && selectedDay) {
        ...
        // used to get the date data
        // freesound.textSearch("&page_size=150", { 
        //     filter: "tag:ambience duration:[* TO 150.0]", 
        //     sort: "downloads_desc", 
        //     fields: 'created,id,name',
        //     group_by_pack: 1
        // }, sounds => {
        ...
        //             ids[months[parseInt(result.created.substring(5, 7))-1]+" "+parseInt(result.created.substring(8,10))] = result.id
        //         }
        //     })
        //     recCall(sounds, 0)
...
// recursive calls until data is sufficient
